...
def cls_loss_local(mesh_struct, logits, n_class):
    ...
    return mesh_cls_loss_wd(label, logits, n_class)
...
MAX_NUM_VERTICES = 1024 # 800
MAX_NUM_FACES = 2048 # 1600
#NUM_TRAIN = 60000
#NUM_TEST = 10000
...
def SN_create_mesh_tf(batch, provider):
    ...
    mesh.OV = tf.placeholder(tf.float32, shape=[batch, n, 3], name='V')
